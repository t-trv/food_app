import generatePages from "../../libs/generatePages.js";
  ...
  return (
    <div className="flex justify-center items-center gap-2">
      ...
      {pages.map((i) => (
        <button
          ...
          className={`px-5 py-2 rounded-lg transition-all duration-300 cursor-pointer ${
            page == i ? "bg-secondary text-white" : "hover:bg-secondary hover:text-white"
          }`}
        >
          {i}
        </button>
      ...
      <button
        ...
        className={`bg-white text-secondary px-4 py-2 rounded-lg transition-all duration-300 cursor-pointer ${
          page == totalPages ? "opacity-50" : "hover:bg-secondary hover:text-white"
        }`}
      >
        Sau
      </button>
